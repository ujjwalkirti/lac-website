      ...
      <div className="flex flex-col lg:flex-row lg:mt-[36px] gap-4">
        ...
        >
          <div className="relative h-[60vh] w-full ">
            ...
            />
            <div className="absolute right-0 bottom-1/4 rounded-l-md px-3 py-2 z-10 bg-white dark:text-[#2c1810]">
              <p
              ...
              <p className="italic text-sm text-gray-400 my-2 text-right">
                {featuredBlogs[0].blog.author}, 21 days ago
              </p>
            </div>
          </div>
        </Link>
        ...
        <div className="lg:w-1/2 flex flex-col justify-between gap-4">
          ...
          >
            <Image
              ...
              alt="Featured blog of LAC"
            />
            <div className="dark:text-[#2c1810]">
              {" "}
              <p
                className={"text-xl lg:text-3xl " + libre_caslon_text.className}
              >
              ...
              <p className="italic text-sm text-gray-400 my-2 text-right">
                {featuredBlogs[1].blog.author}, 21 days ago
              </p>
            </div>
          </Link>
          {/* 3rd featured blog */}
          ...
          >
            ...
            <div className="dark:text-[#2c1810]">
              ...
              <p className="italic text-sm text-gray-400 my-2 text-right">
                {featuredBlogs[2].blog.author}, 21 days ago
              </p>
            </div>
          </Link>
        </div>
