    ...
    <div className="flex flex-col space-y-2 relative  w-11/12 lg:w-10/12 h-auto py-5 lg:py-7 px-7 rounded-md bg-[#FFE1BC]">
      ...
      <div className="flex">
        <div className="w-[70%] lg:w-4/5">
          ...
          <Link
            href={`/book_club`}
            className="h-[40px] lg:w-4/5 text-[13px] lg:text-[17px] font-[600] leading-[17.07px] py-[12px] lg:py-[7px] px-[18px] bg-[#DA8E63] text-white rounded-md absolute lg:relative lg:flex lg:items-center"
          >
            Go, have a look!
          </Link>
        </div>
