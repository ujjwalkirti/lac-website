...
const RecentEventDialogueBox = ({ isFirst, isLast }: props) => {
  return (
    <div
      className={
        "transition-all duration-500 ease-in-out hover:w-3/4 px-[32px] pb-[42px] h-[517px] flex flex-col justify-between items-end border border-black dark:border-white rounded-md " +
        `${isFirst ? "w-3/4" : "w-1/4"}`
      }
    >
